...
% L1 = mbs_get_link_id(MBS_info,'myLink_1');
 [L1,L2,L3,L4,L5,L6,L7,L8,L9,L10] = mbs_get_link_id(MBS_info,'Spring_Pod1_A','Spring_Pod1_B','Spring_Pod2_A','Spring_Pod2_B','Spring_Pod3_A','Spring_Pod3_B','Spring_Pod4_A','Spring_Pod4_B','EMAX','EMAY');
...
switch(ilnk)
    case {L1,L2,L3,L4,L5,L6,L7,L8}
        ...
        %
         ...
         case {L9,L10}
%              
%                  MAX_LENGTH = mbs_data.user_model.EMA.Max_Length;
%                  MAX_FORCE  = mbs_data.user_model.EMA.Max_Force;
                  L0    = mbs_data.user_model.EMA.L0;
                  STIFF = mbs_data.user_model.Spring.K*1000;
                 DAMP  = mbs_data.user_model.Spring.C*10000;
