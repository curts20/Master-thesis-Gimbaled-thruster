...
mbs_data_ini = mbs_data;                                                    % Backup of the initial multibody data structure
 ...
 mkdir C:\Users\migue\Documents\MBProjects\Lunar_Lander_Th\Result_Thruster
...
MBS_user.stepL=0.01;
[Max_Thrust]=Rocket_Engines_Th(mbs_data);
...
figure;
hold on
plot(mbs_dirdyn.tsim,mbs_dirdyn.q(:,8));
title(' 8')
figure;
hold on
plot(mbs_dirdyn.tsim,MBS_user.Tank_fuel/MBS_user.Tank_fuel(1)*100);
title('% Of Fuel Left')
% figure;
...
% title('Rotation acc')
 figure;
plot(mbs_dirdyn.tsim,mbs_dirdyn.q(:,19));
title('Actuator')
hold on
 figure;
...
%% Data output
    ...
    cd C:\Users\migue\Documents\MBProjects\Lunar_Lander_Th\Result_Thruster
  ...
  xlswrite(filename,mbs_dirdyn.q,'Postion')
   xlswrite(filename,mbs_dirdyn.qd,'Velocity')
    ...
    cd C:\Users\migue\Documents\MBProjects\Lunar_Lander_Th\workR
